...
Item {
    ...
    MenuBlob {
        ...
        onTargetMaxYChanged: if (root.menuRect.width > 0)
            cachedMaxY = targetMaxY
        onTargetWidthChanged: if (root.menuRect.width > 0)
                ...
                MouseArea {
                    ...
                    onClicked: mouse => {
                        if (mouse.button === Qt.LeftButton)
                            ...
                            itemRoot.modelData.contextMenu();
