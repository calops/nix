local function hl_override(palette)
	...
	return {
		...
		["@property"] = { fg = colors.brighten(palette.yellow, 0.5) },
		["@variable.member"] = { fg = colors.brighten(palette.yellow, 0.5) },

		-- ["@lsp.type.struct"] = { fg = palette.yellow },
		["@lsp.type.property"] = { fg = colors.brighten(palette.yellow, 0.5) },
